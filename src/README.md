...
- **[frontend](file:///d:/code/AutoLangC/src/frontend)**: Contains components responsible for lexical analysis (Lexer), syntax analysis (Parser), and the language frontend library implementations.
