...
#define create_operator_func_plus(name, op)                                                                               \
...
#define create_operator_func_number_equal(name, op)    \
	...
	{                                                  \
		...
		{
			return ObjectManager::createBoolObject(stackAllocator[0]->b && stackAllocator[1]->b);
		}
		...
		{
			return ObjectManager::createBoolObject(stackAllocator[0] == stackAllocator[1]);
		}
