...
void ParserContext::init(CompiledProgram &compile) {
	...
	lexerString.emplace_back("arrayOf");
	lexerString.emplace_back("listOf");
	lexerString.emplace_back("mutableListOf");
	lexerString.emplace_back("arrayListOf");
	lexerString.emplace_back("emptyArray");
	lexerString.emplace_back("emptyList");
	lexerString.emplace_back("intArrayOf");
	lexerString.emplace_back("floatArrayOf");
	lexerString.emplace_back("doubleArrayOf");
	lexerString.emplace_back("booleanArrayOf");
	lexerString.emplace_back("stringArrayOf");
	lexerString.emplace_back("longArrayOf");
	lexerString.emplace_back("byteArrayOf");
	lexerString.emplace_back("setOf");
	lexerString.emplace_back("mutableSetOf");
	lexerString.emplace_back("hashSetOf");
	lexerString.emplace_back("linkedSetOf");
	lexerString.emplace_back("emptySet");
	lexerString.emplace_back("mapOf");
	lexerString.emplace_back("mutableMapOf");
	...
	*/
	...
	lexerStringMap["arrayOf"] = lexerIdarrayOf;
	lexerStringMap["listOf"] = lexerIdlistOf;
	lexerStringMap["mutableListOf"] = lexerIdmutableListOf;
	lexerStringMap["arrayListOf"] = lexerIdarrayListOf;
	lexerStringMap["emptyArray"] = lexerIdemptyArray;
	lexerStringMap["emptyList"] = lexerIdemptyList;
	lexerStringMap["intArrayOf"] = lexerIdintArrayOf;
	lexerStringMap["floatArrayOf"] = lexerIdfloatArrayOf;
	lexerStringMap["doubleArrayOf"] = lexerIddoubleArrayOf;
	lexerStringMap["booleanArrayOf"] = lexerIdbooleanArrayOf;
	lexerStringMap["stringArrayOf"] = lexerIdstringArrayOf;
	lexerStringMap["longArrayOf"] = lexerIdlongArrayOf;
	lexerStringMap["byteArrayOf"] = lexerIdbyteArrayOf;
	lexerStringMap["setOf"] = lexerIdsetOf;
	lexerStringMap["mutableSetOf"] = lexerIdmutableSetOf;
	lexerStringMap["hashSetOf"] = lexerIdhashSetOf;
	lexerStringMap["linkedSetOf"] = lexerIdlinkedSetOf;
	lexerStringMap["emptySet"] = lexerIdemptySet;
	lexerStringMap["mapOf"] = lexerIdmapOf;
	lexerStringMap["mutableMapOf"] = lexerIdmutableMapOf;
