...
constexpr ClassId functionClassId = 7;
constexpr ClassId exceptionClassId = 8;
constexpr ClassId arrayClassId = 9;
constexpr ClassId setClassId = 10;
constexpr ClassId mapClassId = 11;
